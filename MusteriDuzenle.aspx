<%@ Page Title="" Language="C#" MasterPageFile="~/MP1.master" AutoEventWireup="true" CodeFile="MusteriDuzenle.aspx.cs" Inherits="Default2" %>
...
<div>
    ...
    <li>
        ...
        <asp:DropDownList ID="ddl_kullanici_adi" runat="server"  class="dropdownlist_il">
        </asp:DropDownList>    <br />
    </li>
    <li>
    ...
    <li>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="btn_guncelle" runat="server" Text="Güncelle" 
            Height="30px" Width="86px" onclick="btn_guncelle_Click" />
    </li>
